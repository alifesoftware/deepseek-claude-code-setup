...
# The messages endpoint is at /anthropic/v1/messages (not /anthropic/messages).
# Token Plan subscribers use https://token-plan-cn.xiaomimimo.com/anthropic/v1 instead.
